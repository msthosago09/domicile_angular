...
$headers[] = "X-Mailer: PHP/".phpversion();
    ...
    $body .= "<strong>Name: </strong>" . $name . "</p><br/>";
    $body .= "<strong>Email: </strong>" . $email . "</p><br>";
    $body .= "<strong>Subject: </strong>" . $subject . "</p><br/>";
    $body .= "<strong>Message: </strong>" . $message . "</p></div>"; 

    //replace with your email
    mail("info@domicilegroup.co.za","Mail sent from user",$body,implode("\r\n", $headers));
?>
